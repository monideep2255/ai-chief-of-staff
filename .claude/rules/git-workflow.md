...
**Gitignored paths:** check this repo's `.gitignore` for the current list; add any folder here that holds personal drafts, calendars, or scratch exports you don't want in version control.
