...
| CLAUDE.md | README.md | Rules table (both list all 34 rules) |
...
|------|--------------|-------|
| CLAUDE.md | All 26 skills, all 8 agents, all 34 rules, session-greeting, docs-sync | 40+ |
| AGENTS.md | All 26 skills, all 8 agents, docs-sync | 30+ |
| .claude/README.md | All 26 skills, all 8 agents, all 34 rules | 30+ |
